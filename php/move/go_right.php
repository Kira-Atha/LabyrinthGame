<?php
    ...
    // En allant vers la droite, il n'est possible d'atteindre que l'extrême est du labyrinthe. Si la case où le joueur souhaite se rendre n'est pas un mur, alors d'autres tests peuvent avoir lieu.
    if ($laby[$Z][$X][$Y+1] == 1 || $Y + 1 >= 15) {
        echo "N_OK";
    } else {
        $newY = $Y + 1;
