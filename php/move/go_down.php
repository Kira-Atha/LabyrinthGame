...
// En allant vers le bas, il n'est possible d'atteindre que l'extrême sud du labyrinthe. Si la case où le joueur souhaite se rendre n'est pas un mur, alors d'autres tests peuvent avoir lieu.
    if($laby[$Z][$X+1][$Y]==1 || $X+1>=15){
        echo "N_OK";
    }else{
        $newX=$X+1;
